...
<div class="view-content as-container as-cards as-cards__wrapper <?php print $classes; ?>">
  ...
  <?php if ($rows): ?>
      <article class="as-card as-card--article stamp" aria-label="Video of seniors discussing their journey">
              <a class="popLink" href="https://www.youtube.com/watch?v=vLpwvgX7BYM">
            <div class="hasIcon-YT">
                <img src="http://as.cornell.edu/sites/as/files/seniors-2018-2.jpg" alt="2018 Seniors in theatre">
            </div>
